...
const Layout = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="fixed top-0 w-full bg-neutral-900 px-4 py-2 sm:px-6 sm:py-3 border-b border-neutral-700 z-50">
      ...
      {/* Sidebar */}
      {menuOpen && (
        <div className="fixed top-0 z-[15] md:block w-16 bg-neutral-900 min-h-screen border-r border-neutral-700 pt-16">
      ...
      <div className="flex justify-center md:ps-16 pt-11 sm:pt-12 md:pt-14 max-h-screen">
        {/* Main Content Area */}
