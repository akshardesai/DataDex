...
export default function ImageBtn({member}) {
      ...
      <Modal
        ...
        header={
          <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t border-neutral-500">
                <h3 class="capitalize text-lg font-semibold text-white">{member.name || "N/A"} - <span className="text-md ">{member.idNo || ""}</span> </h3>
