  ...
  return (
    <>
      ...
      <Modal
        ...
        footer={""}
      >
        <form class="p-4 md:p-5 " onSubmit={(e) => editMemberSubmit(e)}>
          <div class="grid gap-4 mb-4 grid-cols-2">
            <div class="col-span-1">
              ...
              <input
                ...
                name="name"
                id="name"
                class="bg-neutral-700 outline-none border border-neutral-600 text-white text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                placeholder="Kabir"
                required
              />
            </div>
            ...
            <div class="col-span-1">
              ...
              <select
                ...
                id="category"
                class="bg-neutral-700 border outline-none border-neutral-600 text-white text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5"
              >
            ...
            <div class="col-span-2">
              ...
              <textarea
                ...
                id="description"
                rows="4"
                class="mt-1 block p-2.5 w-full text-sm text-white bg-neutral-700 rounded-lg border border-neutral-600 outline-none"
